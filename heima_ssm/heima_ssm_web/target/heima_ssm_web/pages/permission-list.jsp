						...
						<div class="table-box">
							...
							<table id="dataList"
								...
								<tbody>
									...
									<c:forEach items="${permissionList}" var="pp">
										<tr>
											<td><input name="ids" type="checkbox"></td>
											<td>${pp.id }</td>
											<td>${pp.permissionName }</td>
											<td>${pp.url }</td>
											<td class="text-center">
												<a href="${pageContext.request.contextPath}/role/findById.do?id=${pp.id}" class="btn bg-olive btn-xs">详情</a>
												<a href="${pageContext.request.contextPath}/user/findUserByIdAndAllRole.do?id=${pp.id}" class="btn bg-olive btn-xs">添加角色</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
